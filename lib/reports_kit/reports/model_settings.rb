  ...
  module Reports
    class ModelSettings
      ...
      def settings_from_model
        ...
        return {} if model_configuration.public_send(model_configuration_type).blank?
        config_hash = model_configuration.public_send(model_configuration_type).find do |hash|
          hash[:key] == key
        end
        config_hash || {}
      end
